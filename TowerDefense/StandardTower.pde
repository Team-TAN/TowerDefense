class StandardTower extends TowerTile {
  ...
  public StandardTower() {
    super(new UpgradeData[] { new UpgradeData(50, 25, 150, .5f, 0), new UpgradeData(75, 40, 200, .45f, 100), new UpgradeData(100, 50, 225, .35f, 200), new UpgradeData(125, 65, 250, .25f, 300) }, 1000, 60, 6);
  }
